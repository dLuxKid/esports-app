...
export default function CarouselSection() {
    ...
    return (
        <section
            className='flex-start text-white min-h-screen bg-cover animate-fadein'
            style={{
        ...
        >
            <div className="gap-4 flex-start mb-24 flex-col">
                <h1 className="header-text w-4/5">Unleash Your Competitive Spirit in the Ultimate Esports Arena</h1>
